...
public class GameMgr : MonoBehaviour
{
    ...
    public bool IsBallLaunched { get { return isBallLaunched; } }

    private GameObject playerGao;
    public GameObject PlayerGao { get { return playerGao; } }
    ...
    public bool IsTrainingModeOn { get { return isTrainingModeOn; } }
    [SerializeField]
    ...
    void Update()
    {
        if (isTrainingModeOn && isBallLaunched == false)
        {
            ...
            if (trainingStep == nbTrainingSteps - 1)
                isTrainingPosDownward = !isTrainingPosDownward;
